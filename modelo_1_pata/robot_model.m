...
%labels = {'coxis','Femur','Tibia de Insaurralde'};
%h_first = NaN(1,3);
%h_first(coxa) = h(ind(1));
   ...
   for leg = 0%:1:5
        ...
        % kinematic chain for each leg using D-H notation
            ...
            %plot the link
                    plot3([T(1,4) Ai(1,4)],[T(2,4) Ai(2,4)],[T(3,4) Ai(3,4)],colors(leg+1),'Linewidth',2)
                    hold on
...
%          
        ...
        %It plots a line between the center of the robot and the end of the
        %coxa. In other words, it plots the coxa itself.
             plot3([P(1,4) Ai(1,4)],[P(2,4) Ai(2,4)],[P(3,4) Ai(3,4)],'r','Linewidth',2)
             hold on
...
%             %calculate next transformation in the kinematic chain
             ...
             %params(i,3)+params(i,5) = theta_i + theta_off
%             %plot the link
                 plot3([T(1,4) Ai(1,4)],[T(2,4) Ai(2,4)],[T(3,4) Ai(3,4)],'g','Linewidth',2)
                 hold on
%             
%             %plot reference frames
%             x0 = Ai(1:3,1:3)*[1;0;0];
