function [ error_en_z_final] = error_en_z_vs_porcentaje_ruido_theta_3_off(p1,p2,p3,pata,iteraciones,errormax,pasoo)
   ...
   error_en_z_final =[];
    for porcentajeError = 1:paso:error_max
        for iteracion = 1:1:num_iters
            p3.theta_off = theta_off_elegido + (porcentajeError/100)*theta_off_elegido*rand();
