function [ error_en_z_final] = error_en_z_vs_porcentaje_ruido_theta_3_off(p1,p2,p3,pata,errormax,pasoo)
    pose_real = forward_kinematics(p1,p2,p3,pata);
    error_max = errormax;
    paso = pasoo;
    param_elegido = p3.theta_off;
   error_en_z_final =[];
    for porcentajeError = 1:paso:error_max
 
            p3.theta_off = param_elegido + (porcentajeError/100)*param_elegido;
