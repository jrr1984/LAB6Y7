...
grupo2 = 1.3:pasoo:(errormax+0.3);  % Define position for 12 Month_S boxplots  
...
hold on
   ...
   grupo3 = 1.6:pasoo:(errormax+0.6);  % Define position for 12 Month_S boxplots  
...
hold on
  ...
  grupo4 = 1.9:pasoo:(errormax+0.9);  % Define position for 12 Month_S boxplots  
...
grupo5 = 2.2:pasoo:(errormax+1.2);  % Define position for 12 Month_S boxplots  
