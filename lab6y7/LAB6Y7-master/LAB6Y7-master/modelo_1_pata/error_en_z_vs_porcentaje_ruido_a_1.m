function [ error_en_z_final] = error_en_z_vs_porcentaje_ruido_a_1(p1,p2,p3,pata,iteraciones,errormax,pasoo)
   ...
   error_en_z_final =[];
    for porcentajeError = 1:paso:error_max
        for iteracion = 1:1:num_iters
            p1.a = param_elegido + (porcentajeError/100)*param_elegido*rand();
