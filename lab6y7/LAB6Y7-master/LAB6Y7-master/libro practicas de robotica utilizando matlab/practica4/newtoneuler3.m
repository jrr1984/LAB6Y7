...
%	los parametros:
%	- TETA: Vector 3x1 de posición de las articulaciones (rad)
%	- QP: Vector 3x1 de velocidad de cada articulación (rad/s)
%	- QPP: Vector 3x1 de aceleración de cada velicidad (rad/s^2)
